...
sample_monkeys = {
        0: Monkey(0, [79, 98], lambda x: x*19, lambda x: floor(x/3), lambda x: x%23 == 0, None, None),
        1: Monkey(1, [54, 65, 75, 74], lambda x: x+6, lambda x: floor(x/3), lambda x: x%19 == 0, None, None),
        2: Monkey(2, [79, 60, 97], lambda x: x*x, lambda x: floor(x/3), lambda x: x%13 == 0, None, None),
        3: Monkey(3, [74], lambda x: x+3, lambda x: floor(x/3), lambda x: x%17 == 0, None, None),
        }
...
monkeys = {
        0: Monkey(0, [80], lambda x: x*5, lambda x: floor(x/3), lambda x: x%2 == 0, None, None),
        1: Monkey(1, [75, 83, 74], lambda x: x+7, lambda x: floor(x/3), lambda x: x%7 == 0, None, None),
        2: Monkey(2, [86, 67, 61, 96, 52, 63, 73], lambda x: x+5, lambda x: floor(x/3), lambda x: x%3 == 0, None, None),
        3: Monkey(3, [85, 83, 55, 85, 57, 70, 85, 52], lambda x: x+8, lambda x: floor(x/3), lambda x: x%17 == 0, None, None),
        4: Monkey(4, [67, 75, 91, 72, 89], lambda x: x+4, lambda x: floor(x/3), lambda x: x%11 == 0, None, None),
        5: Monkey(5, [66, 64, 68, 92, 68, 77], lambda x: x*2, lambda x: floor(x/3), lambda x: x%19 == 0, None, None),
        6: Monkey(6, [97, 94, 79, 88], lambda x: x*x, lambda x: floor(x/3), lambda x: x%5 == 0, None, None),
        7: Monkey(7, [77, 85], lambda x: x+6, lambda x: floor(x/3), lambda x: x%13 == 0, None, None),
        }
...
inspection_counts = get_inspection_counts(monkeys, 20)
