...
def get_shortest_route(start_location, end_location, start_time):
    highest_steps = 0
    search_start = SearchLocation(start_location, start_time)
    to_search = PriorityQueue()
    to_search.put(search_start)
    searched = set()
    best_paths = defaultdict(list)
...
first_trip = get_shortest_route(start_location, end_location, 0)
second_trip = get_shortest_route(end_location, start_location, first_trip)
third_trip = get_shortest_route(start_location, end_location, second_trip)
print(third_trip)
